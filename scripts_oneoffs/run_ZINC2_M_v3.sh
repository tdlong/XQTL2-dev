#!/bin/bash
###############################################################################
# run_ZINC2_M_v3.sh — Analyze pB males with updated XQTL2 pipeline
#
...
# OUTPUT: process/ZINC2/ZINC2_M_v3/
#
# Run from: /dfs7/adl/tdlong/fly_pool/XQTL2
#
# DEPLOYMENT:
#   scp pipeline/run_ZINC2_M_v3.sh tdlong@hpc3.rcic.uci.edu:/dfs7/adl/tdlong/fly_pool/XQTL2/
#   ssh hpc3 "cd /dfs7/adl/tdlong/fly_pool/XQTL2 && bash run_ZINC2_M_v3.sh"
###############################################################################
...
echo "=== ZINC2 males reanalysis with updated XQTL2 pipeline ==="
echo "Design:    $DESIGN"
echo "Dir:       $DIR"
echo "Scan:      $SCAN"
