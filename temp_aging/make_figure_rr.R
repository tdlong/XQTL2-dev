...
# This draws the second so it can be compared against the first.
#
...
p <- ggplot(rr) +
  ...
  geom_line(aes(gx, rate, group = chr), linewidth = 0.4, colour = "grey15") +
